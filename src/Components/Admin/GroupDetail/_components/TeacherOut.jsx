...
export default function TeacherOut({ id, refresh }) {
        ...
        <>
            ...
            <Dialog open={open} handler={handleOpen} size="xs">
                <DialogHeader className="text-lg font-semibold flex items-center gap-2">
                    Ustozni guruhdan chiqarish
                </DialogHeader>

                <DialogBody className="text-gray-700 text-[15px] font-bold py-0">
                    Siz rostdan ham ushbu ustozni guruhdan chiqarmoqchimisiz?
                </DialogBody>
