    ...
    return (
        <div className="container mx-auto w-full px-2 md:px-4">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 gap-3">
                ...
                <div className={`px-3 py-1 rounded-full text-sm w-max self-start md:self-auto ${group.status ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                    }`}>
            ...
            <div className="flex flex-col lg:flex-row items-start gap-6 w-full">
                        ...
                        {openAccordion === 1 && (
                            <div className="px-6 pb-4">
                                {employees.length > 0 ? (
                                    ...
                                    <div className="text-gray-500 text-center py-4">Ustoz belgilanmagan</div>
                                )}
                            </div>
                        )}
                    </div>
                        ...
                        {openAccordion === 2 && (
                            <div className="px-6 pb-4 space-y-3">
                                {students.length > 0 ? (
                                    ...
                                    <div className="text-gray-500 text-center py-4">O'quvchilar mavjud emas</div>
                                )}
                            </div>
                        )}
                    </div>
                ...
                "
                >
                    <Attendance students={students} group={group} />
                </div>
            </div>
        </div>
    );
